<?php /* Smarty version Smarty-3.1.16, created on 2016-01-11 09:58:16
         compiled from "admin\listNews.php" */ ?>
<?php /*%%SmartyHeaderCode:1564256930c38225519-66688184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dee6b846e2738be7cae341a93f620c7798ce87df' => 
    array (
      0 => 'admin\\listNews.php',
      1 => 1452009903,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1564256930c38225519-66688184',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_56930c38319754_07399125',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56930c38319754_07399125')) {function content_56930c38319754_07399125($_smarty_tpl) {?><<?php ?>?php
//调用数据库配置文件
session_start();
...
<tr><td colspan="3"><a href="javascript:;" id="del"><img src="images/delete.png"/></a></td></tr>
	...
	<tr class="tr">
		...
		<td><<?php ?>?php echo $row['subject']?<?php ?>></td>
		<td><a href="index.php?act=updatenews&ctl=News&id=<<?php ?>?php echo $row['id']?<?php ?>>" target="mainFrame" id="update">编辑</a></td>
	</tr>
	<<?php ?>?php }?<?php ?>>
	</tbody>
	<tr class="page">
		<td colspan="3"><<?php ?>?php echo $page->diplayblock();?<?php ?>></td>
	</tr>
</table>
</body>
</html><?php }} ?>
